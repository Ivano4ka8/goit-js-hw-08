...
player.setCurrentTime(JSON.parse(localStorage.getItem('CURRENT_TIME_KEY')));//забираємо час під час перезавантаження сторінки для відтворення на тому самому місці
